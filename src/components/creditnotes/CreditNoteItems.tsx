...
const CreditNoteItems: React.FC<CreditNoteItemsProps> = ({
  items,
  availableItems,
  vats,
  currencySymbol,
        ...
        {items.map((item) => (
          <div key={item.id} className="flex flex-col md:grid md:grid-cols-12 gap-3 md:gap-4 md:items-center border-b pb-4 md:pb-2 md:border-0">
            ...
            <div className="md:col-span-4">
              {readOnly ? (
                <div className="p-2">{availableItems.find(i => i.id === item.description)?.title || item.description}</div>
              ) : (
                <Select
            ...
            <div className="md:col-span-2">
              {readOnly ? (
                <div className="p-2">{currencySymbol}{item.unit_price.toFixed(2)}</div>
              ) : (
            ...
            <div className="md:col-span-2">
              {readOnly ? (
                <div className="p-2">{getVatDisplayText(item.vat_rate)}</div>
              ) : (
                <Select
                  value={item.vat_rate}
